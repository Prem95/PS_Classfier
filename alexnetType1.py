...
class AlexNet(object):
    ...
    def create(self):
        ...
        fc6 = fc(flattened, 6*6*256, 4096, name='fc6') # Fully connected layer
        ...
        # The training features are extracted in FC7 and classified at FC8

        #! Only 2 classes are output. Get this model as the output
